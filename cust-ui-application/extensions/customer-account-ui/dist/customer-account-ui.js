(() => {
  ...
  // extensions/customer-account-ui/src/MenuActionExtension.jsx
...
${errorInfo.componentStack}`);
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/customer-account/hooks/metafields.mjs
  ...
  var MenuActionExtension_default = reactExtension("customer-account.order-status.block.render", () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(UpdateOrderExtension, {}));
  function UpdateOrderExtension() {
    const { query } = useApi();
    const order = useOrder();
    const orderId = order.id.replace("gid://shopify/Order/", "");
    const [metafield, setMetafield] = (0, import_react12.useState)(null);
    const [error, setError] = (0, import_react12.useState)(null);
    const metafields = useMetafields();
    (0, import_react12.useEffect)(() => {
      const fetchMetafield = () => __async(this, null, function* () {
        var _a, _b;
        console.log("Entered");
        try {
          ...
          const data = (_b = (_a = response == null ? void 0 : response.data) == null ? void 0 : _a.order) == null ? void 0 : _b.metafield;
          setMetafield(data);
        } catch (error2) {
          setError(error2);
        }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button2, { children: orderId });
  }
})();
